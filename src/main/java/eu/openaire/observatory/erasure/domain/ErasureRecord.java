 ...
 * {@link #executedBy} is the id of the administrator who ran the erasure, retained as
 * controller-accountability data.
 *
 * <p>Wired by {@code ErasureDatasourceConfig} onto its own {@code erasure} datasource and schema on
 * the registry database; new tables are created by that datasource's {@code hbm2ddl.auto=update}.
 * Existing subject-keyed tables require the explicit migration documented in
 * {@code docs/user-erasure.md}.
 *
