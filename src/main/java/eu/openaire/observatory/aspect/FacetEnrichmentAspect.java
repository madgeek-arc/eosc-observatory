...
public class FacetEnrichmentAspect {
    ...
    @AfterReturning(pointcut = "within(eu.openaire.observatory.service.SurveyService+) && execution(* browseSurveyAnswersInfo(gr.uoa.di.madgik.registry.domain.FacetFilter) )",
            returning = "browsing")
