...
public class PermissionsUpdateAspect {
    ...
    @AfterReturning(value = "execution(* eu.openaire.observatory.service.SurveyAnswerCrudService.add(..))", returning = "surveyAnswer")
    ...
    @AfterReturning(value = "execution(* eu.openaire.observatory.service.SurveyAnswerCrudService.delete(..))", returning = "surveyAnswer")
